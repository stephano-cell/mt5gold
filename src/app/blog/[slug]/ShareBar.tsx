...
export default function ShareBar({ slug, headline }: { slug: string; headline: string }) {
  ...
  return (
    <div className="flex items-center gap-2 mt-6 pt-5 border-t border-white/10">
      ...
      <a
        ...
        target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/10 text-xs text-gray-400 hover:text-blue-400 hover:border-blue-500/20 transition-all"
      >
        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
