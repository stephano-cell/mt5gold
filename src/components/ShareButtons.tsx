...
export default function ShareButtons({ url, text }: { url: string; text: string }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {/* X / Twitter */}
      <a
        href={`https://twitter.com/intent/tweet?text=${encodedText}&url=${encodedUrl}&via=thrivenex`}
      ...
      <a
        ...
        target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/10 text-xs text-gray-400 hover:text-[#1877F2] hover:border-[#1877F2]/20 transition-all"
      >
        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a
        ...
        target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/10 text-xs text-gray-400 hover:text-[#0088cc] hover:border-[#0088cc]/20 transition-all"
      >
